...
const archivedBoardList = (z, bundle) => {
  // `z.console.log()` is similar to `console.log()`.
  z.console.log("board is archived");
...
module.exports = {
  ...
  display: {
    ...
    description: "Triggers when a board is archived.",
  },
  ...
  operation: {
    ...
    sample: {
      ...
      user_who_archived: "owner@gmail.com",
    },
    ...
    outputFields: [
      ...getBoardOutputFields(),
      { key: "user_who_archived", label: "User who archived", type: "string" },
    ],
  },
};
