...
const { getBoardOutputFields, getBoardSample } = require("./utils");

const createdBoardList = (z) => {
  // `z.console.log()` is similar to `console.log()`.
  z.console.log("board is created");
...
module.exports = {
  ...
  operation: {
    ...
    sample: {
      ...
      user_who_created: "owner@gmail.com",
    },
    ...
    outputFields: [
      ...
      {
        key: "user_who_created",
        label: "User who created a board",
        type: "string",
      },
    ],
  },
