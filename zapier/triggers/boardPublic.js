...
module.exports = {
  ...
  display: {
    label: "Board Public",
    description: "Triggers when a board is public.",
  },
  ...
  operation: {
    ...
    sample: {
      ...
      board_public_url:
        "https://whatboard.app/readonlyboard/abc123?invitation=akjfhjaefjeakfaefjdajkfadfadskjfjnadkjf",
      // eslint-disable-next-line camelcase
      user_who_made_public: "owner@gmail.com",
    },
