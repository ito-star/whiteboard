...
const invitedBoardList = (z, bundle) => {
  // `z.console.log()` is similar to `console.log()`.
  z.console.log("board is invited");
...
module.exports = {
  ...
  display: {
    label: "Board Invited",
    description: "Triggers when a board is invited.",
  },
  ...
  operation: {
    ...
    sample: {
      ...
      invited_user_email: "user@gmail.com",
      // eslint-disable-next-line camelcase
      inviter_name: "John Smith",
      // eslint-disable-next-line camelcase
      inviter_email: "john.smith@email.com",
    },
